...
plugin.Tx_Formhandler.settings.predef.formhandler-basic-contactform {
	...
	langFile.1 = TEXT
	langFile.1.value = typo3conf/ext/we_custom/Resources/Private/Language/locallang_formhandler_default.xml

	templateFile = TEXT
	templateFile.value = typo3conf/ext/we_custom/Resources/Private/Templates/Plugin/formhandler/contactform.html
	...
	masterTemplateFile.value = typo3conf/ext/we_custom/Resources/Private/Templates/Plugin/formhandler/mastertemplate.html
	...
	finishers {
		...
		1.config {
			...
			admin {
				templateFile = TEXT
				templateFile.value = typo3conf/ext/we_custom/Resources/Private/Templates/Plugin/formhandler/email-admin.html
				...
				subject = TEXT
				subject.data = LLL:typo3conf/ext/we_custom/Resources/Private/Language/locallang_formhandler_default.xml:email_admin_subject
			}
		}
...
plugin.Tx_Formhandler.settings.predef.formhandler-basic-contactform {
	finishers {
		1.config {
			user {
				templateFile = TEXT
				templateFile.value = typo3conf/ext/we_custom/Resources/Private/Templates/Plugin/formhandler/email-user.html
				sender_email = {$formhandlerExamples.basic.contact-form.email.user.sender_email}
				to_email = email
				subject = TEXT
				subject.data = LLL:typo3conf/ext/we_custom/Resources/Private/Language/locallang_formhandler_default.xml:email_user_subject
			}
		}
	}
}
